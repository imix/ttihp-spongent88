...
# Source: https://github.com/joostrijneveld/readable-crypto/blob/master/hashfunctions/SPONGENT.py
# Vendored verbatim as the independent reference for cross-checking spongent88_ref.py.
